...
-- Dumping data for table `system_logs` (3 rows)
...
INSERT INTO `system_logs` (`id`, `timestamp`, `user_id`, `username`, `action`, `description`, `ip_address`, `level`, `module`) VALUES ('3', '2025-03-17 03:53:56', '20', 'Mohammed Mikou', 'Backup Created', 'Created database backup: backup_2025-03-17_03-53-56.sql', '0', 'info', 'backup');
